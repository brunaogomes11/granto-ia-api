...
@app.route("/testar/<genero>/<idade>/<debito>/<casado>/<possui_conta_banco>/<tipo_industria>/<etnia>/<anos_empregado>/<inadimplencia>/<empregado>/<pontuacao_credito>/<habilitado>/<cidadania>/<codigo_postal>/<renda>", methods=["GET"])
